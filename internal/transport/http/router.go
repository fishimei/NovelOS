...
func NewRouter(handlers Handlers) *gin.Engine {
	...
	api := router.Group("/api/v1")
	{
		...
		api.POST("/story-sessions/:session_id/auto/start", handlers.StorySessions.StartAuto)
		api.POST("/story-sessions/:session_id/auto/stop", handlers.StorySessions.StopAuto)
		api.GET("/story-sessions/:session_id/auto", handlers.StorySessions.GetAuto)
		...
		api.GET("/projects/:project_id/world-map/areas", handlers.World.ListMapAreas)
		...
		api.GET("/projects/:project_id/locations/:location_id", handlers.World.GetLocation)
		api.POST("/projects/:project_id/locations/:location_id/inspect", handlers.World.InspectLocation)
